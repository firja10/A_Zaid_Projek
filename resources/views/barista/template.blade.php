...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Owner <sup></sup></div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('/barista/stok_produk')}}">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{url('/barista/ShowPemesanan')}}">
                    <i class="fas fa-fw fa-clipboard-list"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Barista</span>
    ...
    <form action="{{route('StokProdukStore')}}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="#modaltambahProdukLabel">Tambah Data Aktivitas</h5>
              <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
              </button>
          </div>
          <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kategori_produk" id="kategori_produk" class = "form-control" placeholder="Masukkan Kategori Produk">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="stok_produk" id="stok_produk" class = "form-control" placeholder="Masukkan Stok Produk">
            </div>
    
                <div class="form-group">
                    <label for="image_produk"> Foto Aktivitas</label>
